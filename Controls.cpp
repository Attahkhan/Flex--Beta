...
{ // credits azuri bro
	...
	Render::Outline(a.x, a.y, 23, 13, Color(129, 129, 129, 255));
	Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(120, 0, 0, 255));
	Render::Clear(a.x + 12, a.y + 2, 9, 9, Color(0, 44, 102, 255));
	...
	if (hover)
	{
		if (Checked)
		{
			Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(0, 44, 122, 255));
			Render::Clear(a.x + 12, a.y + 2, 9, 9, Color(0, 0, 200, 255));
		}
		else
		{
	...
	{
		Render::Clear(a.x + 2, a.y + 2, 9, 9, Color(0, 44, 122, 255));
		Render::Clear(a.x + 12, a.y + 2, 9, 9, Color(0, 200, 0, 255));
	}
}

void CCheckBox::OnUpdate() { m_iWidth = 24; m_iHeight = 12; }
...
{
	int r = Menu::Window.MenuTab.GrouptextR.GetValue();
	int g = Menu::Window.MenuTab.GrouptextG.GetValue();
	int b = Menu::Window.MenuTab.GrouptextB.GetValue();

	POINT a = GetAbsolutePos();
	Render::Text(a.x, a.y - 1, Color(r, g, b, 255), Render::Fonts::Menu, Text.c_str());
}
...
{
	int r1 = Menu::Window.MenuTab.GroupboxR.GetValue();
	int g1 = Menu::Window.MenuTab.GroupboxG.GetValue();
	int b1 = Menu::Window.MenuTab.GroupboxB.GetValue();
	...
	Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(30, 30, 30, 255));
	Render::Text(a.x + (m_iWidth / 2) - (txtSize.right / 2), a.y - (txtSize.bottom / 2) - 1, Color(r, g, b, 255), Render::Fonts::MenuBold, Text.c_str());

	Render::Line(a.x, a.y, a.x + (m_iWidth / 2) - (txtSize.right / 2) - 1, a.y, Color(57, 57, 57, 255));
	Render::Line(a.x + (m_iWidth / 2) + (txtSize.right / 2) + 1, a.y, a.x + m_iWidth, a.y, Color(57, 57, 57, 255));
	Render::Line(a.x, a.y, a.x, a.y + m_iHeight, Color(57, 57, 57, 255));
	Render::Line(a.x, a.y + m_iHeight, a.x + m_iWidth, a.y + m_iHeight, Color(57, 57, 57, 255));
	Render::Line(a.x + m_iWidth, a.y, a.x + m_iWidth, a.y + m_iHeight, Color(57, 57, 57, 255));

	//Outer

	//Render::Line(a.x, a.y, a.x + (m_iWidth / 2) - (txtSize.right / 2) - 3, a.y, Color(3, 3, 3, 255));
	//Render::Line(a.x + (m_iWidth / 2) + (txtSize.right / 2) + 3, a.y, a.x + m_iWidth, a.y, Color(3, 3, 3, 255));
	//Render::Line(a.x, a.y, a.x, a.y + m_iHeight, Color(3, 3, 3, 255));
	//Render::Line(a.x, a.y + m_iHeight, a.x + m_iWidth, a.y + m_iHeight, Color(3, 3, 3, 255));
	//Render::Line(a.x + m_iWidth, a.y, a.x + m_iWidth, a.y + m_iHeight, Color(3, 3, 3, 255));
}
...
void CGroupBox::PlaceCheckBoxsmall(std::string Label, CTab *Tab, CControl* control)
{
	int x = m_x + 39;
	int y = m_y + Items * 18;
...
void CGroupBox::PlaceOtherControlsmall(std::string Label, CTab *Tab, CControl* control)
{
	int x = m_x + 29;
	int y = m_y + Items * 23;
...
void CGroupBox::PlaceOtherControlsmall2(std::string Label, CTab *Tab, CControl* control)
{
	int x = m_x + 29;
	int y = m_y + Items * 28;
...
void CGroupBox2::Draw(bool hover)
{
	...
	int r = Menu::Window.MenuTab.GroupboxR.GetValue();
	int g = Menu::Window.MenuTab.GroupboxG.GetValue();
	int b = Menu::Window.MenuTab.GroupboxB.GetValue();

	POINT a = GetAbsolutePos();
	RECT txtSize = Render::GetTextSize(Render::Fonts::Icons, Text.c_str());
	Render::Clear(a.x + 2, a.y + 2, m_iWidth - 4, m_iHeight - 4, Color(r1, g1, b1, 255));
	Render::Text(a.x + 15, a.y - (txtSize.bottom / 2), Color(80, 80, 80, 255), Render::Fonts::Icons, Text.c_str());

	Render::Line(a.x, a.y, a.x + 12, a.y, Color(57, 57, 57, 255));
	Render::Line(a.x + 15 + txtSize.right + 5, a.y, a.x + m_iWidth, a.y, Color(57, 57, 57, 255));
...
void CGroupBox2::PlaceCheckBox2(std::string Label, CTab *Tab, CControl* control, int c, int r)
{
	int CellW = (m_iWidth / Columns);
	int x = m_x + 10 + (c * CellW);
	int y = m_y + 26 + r * 22;
	...
	char szCRCBuffer[256];
	sprintf_s(szCRCBuffer, "%s%s", Text.c_str(), Label.c_str());
	control->SetFileID2(CRC32(szCRCBuffer, strlen(szCRCBuffer)));

	m_iHeight = (MaxRow + 1) * 22 + 26;
}

void CGroupBox2::OnUpdate() { m_iWidth = parent->GetClientArea().right - 20; }
...
void CSlider::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y + 1, Location, 7, Color(red, green, blue, 255), Color(20, 20, 20, 245));
	...
	if (Location == 0)
		Render::Text(a.x + (Location)-txtSize.right / 2 - 2 + 3, a.y + 10, Color(255, 255, 255, 255), Render::Fonts::Slider, buffer);
	else
		Render::Text(a.x + (Location)-txtSize.right / 2 - 2, a.y + 2, Color(255, 255, 255, 255), Render::Fonts::Slider, buffer);
}
...
void CKeyBind::Draw(bool hover)
{
	...
	Render::Clear(a.x, a.y, m_iWidth, m_iHeight, Color(60, 60, 60, 255));
...
void CComboBox::Draw(bool hover)
{
	...
	Render::GradientV(a.x + 2, a.y + 2, m_iWidth - 4, 16, Color(43, 43, 43, 255), Color(27, 27, 27, 255));
	...
	if (Items.size() > 0)
	{
		...
		Render::Text(a.x + 4, a.y + (Region.bottom / 2) - (txtSize.bottom / 2), Color(100, 100, 100, 255), Render::Fonts::Menu, GetItem().c_str());
		...
		if (IsOpen)
		{
			...
			for (int i = 0; i < Items.size(); i++)
			{
				...
				if (GUI.IsMouseInRegion(ItemRegion))
				{
					...
					Render::Outline(a.x, a.y + 17 + i * 16, m_iWidth, 16, Color(255, 255, 255, 255));
				}
	...
	Vertex_t Verts2[3];
	Verts2[0].m_Position.x = a.x + m_iWidth - 9;
	Verts2[0].m_Position.y = a.y + 6;
	Verts2[1].m_Position.x = a.x + m_iWidth - 4;
	Verts2[1].m_Position.y = a.y + 6;
	Verts2[2].m_Position.x = a.x + m_iWidth - 6.5;
	Verts2[2].m_Position.y = a.y + 11;

	Render::Polygon(3, Verts2, Color(201, 201, 201, 255));
}
...
void CComboBox2::Draw(bool hover)
{
	...
	RECT Region = { a.x, a.y, m_iWidth, 16 };
	Render::Outline(a.x, a.y, m_iWidth, 20, Color(2, 2, 2, 255));
	Render::GradientV(a.x + 2, a.y + 2, m_iWidth - 4, 16, Color(37, 37, 37, 255), Color(37, 37, 37, 255));
...
void CListBox::Draw(bool hover)
{
	...
	if (Items.size() > 0)
	{
		...
		Render::GradientV(a.x + m_iWidth - LIST_SCROLL_WIDTH, a.y + posRatio, LIST_SCROLL_WIDTH, sizeRatio, Color(57, 57, 57, 255), Color(82, 82, 82, 255));
	}
...
void CSliderFloat::Draw(bool hover)
{
	...
	if (Location == 0)
		...
		Render::Text(a.x + (Location)-txtSize.right / 2 - 2, a.y + 10, Color(255, 255, 255, 255), Render::Fonts::Slider, buffer);
}
