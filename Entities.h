...
char* GetGunName(ItemDefinitionIndex*);
...
public:
	...
	CNETVAR_FUNC(int, GetTeamNum2, 0xC08B6C6E); //m_iTeamNum
	...
	float GetMaxSpeed() // b1g mamba 20 inch cock licker
	{
		static float m_flMaxspeed = GET_NETVAR(XorStr("DT_BasePlayer"), XorStr("m_flMaxspeed"));
	...
	float *GetSimulationTime() {
		static float m_flSimulationTime = GET_NETVAR(XorStr("DT_BaseEntity"), XorStr("m_flSimulationTime"));
	...
	float GetEyeAnglesY() /*m_angEyeAngles[1]*/
	{
		return *(float*)((DWORD)this + GET_NETVAR("DT_CSPlayer", "m_angEyeAngles[1]"));
	}
	...
	Vector GetBonePos(int i)
	{
		...
		if (this->SetupBones2(boneMatrix, 128, 0x100, 0))
		{
